...
while True:
  if a == 'n': 
    ...
    if maior == z and menor == b:
        media = (y + c + d)/3
    if maior == z and menor == c:
        media = (y + b + d)/3
    if maior == z and menor == d:
        media = (y + c + b)/3
    if maior == z and menor == y:
        media = (b + c + d)/3
    if maior == b and menor == z:
        media = (y + c + d)/3
    if maior == c and menor == z:
        media = (y + b + d)/3
    if maior == d and menor == z:
        media = (y + c + b)/3
    if maior == y and menor == z:
        media = (b + c + d)/3    
